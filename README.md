...
Base on [bootstrap-datetimeoptionpicker](https://github.com/ms-zone/react-bootstrap-datetimeoptionpicker.git)

Online demo: https://github.com/ms-zone/react-bootstrap-datetimeoptionpicker.git
...
```sh
# <2.0
npm install react-bootstrap-datetimeoptionpicker onefe-bootstrap-daterangepicker --save

# 2.x
npm install react-bootstrap-datetimeoptionpicker bootstrap-daterangepicker --save
```
...
```js
import DatetimeRangePicker from 'react-bootstrap-datetimeoptionpicker';
